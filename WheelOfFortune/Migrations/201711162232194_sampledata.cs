namespace WheelOfFortune.Migrations
{
    ...
    public partial class sampledata : DbMigration
    {
        public override void Up()
        {
            ...
            Sql(
                "INSERT INTO dbo.WheelConfigurationSlice  (Propability,Type,Value,Win,ResultText,Score,User_id,WheelConfiguration_id) VALUES(" +
                "25,'string','Win x5',1,'You win yeah',5.0,'adf343a0-bfea-4474-82ec-c3185b8a102d',1)");
            ...
            Sql(
                "INSERT INTO dbo.WheelConfigurationSlice  (Propability,Type,Value,Win,ResultText,Score,User_id,WheelConfiguration_id) VALUES(" +
                "10,'string','Win x1.5',1,'You win',1.5,'adf343a0-bfea-4474-82ec-c3185b8a102d',2)");
            ...
            Sql(
                "INSERT INTO dbo.WheelConfigurationSlice  (Propability,Type,Value,Win,ResultText,Score,User_id,WheelConfiguration_id) VALUES(" +
                "10,'string','Win x5',1,'You win yeah',5.0,'adf343a0-bfea-4474-82ec-c3185b8a102d',2)");
            ...
            Sql(
                "INSERT INTO dbo.WheelConfigurationSlice  (Propability,Type,Value,Win,ResultText,Score,User_id,WheelConfiguration_id) VALUES(" +
                "34,'string','Win x15',1,'You win yeah',15.0,'adf343a0-bfea-4474-82ec-c3185b8a102d',3)");
